...
class MovieDetails {
  ...
  @JsonKey(fromJson: parceMovieDateFromString)
...
class ProductionCountrie {
  ...
  final String iso;
  final String name;
  const ProductionCountrie({required this.iso, required this.name});
...
class SpokenLanguage {
  ...
  final String iso;
  final String name;
  const SpokenLanguage({required this.iso, required this.name});
